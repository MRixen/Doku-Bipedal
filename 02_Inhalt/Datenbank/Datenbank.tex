...
Der oben dargestellte Zylinder repräsentiert die externe Cloud, welche über das Internet erreichbar ist. Diese beinhaltet die Bewegungsdaten für alle Motoren, welche zuvor durch das Messsystem aufgenommen und extrahiert wurden. Die Struktur (s. seitlicher Bereich) besteht aus mehreren Datenbanken, von denen jede mehrere Tabellen enthält, in denen die Sensorwerte hinterlegt sind. Abbildung \ref{fig:cloudcontent} zeigt exemplarisch den Aufbau der Cloud.
