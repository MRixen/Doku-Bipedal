...
Die Bestandteile des Hauptrechners sind ein Raspberry-Pi 2 mit Wlan-Adapter und dem Betriebsystem Windows 10 IoT, sowie einer Energiequelle (Akku von Anker) mit 20100 mAh. Für das Konvertieren der Sensordaten von CAN auf SPI wird, in ein Gehäuse integriertes, Mcp2515 verwendet.
...
\begin{itemize}
	...
	\end{figure}
		...
		\item \textbf{Mcp2515 mit Gehäuse}
